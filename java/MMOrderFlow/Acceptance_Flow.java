...
public class Acceptance_Flow extends TestBase{
	LoginPage loginPage;
	...
	public void Verify_ModellingQC_Accept_Test () throws InterruptedException {
		...
		try {
			...
			System.out.println("didn't click on successDialog - mod qc feedback accept stage");
		}
		Thread.sleep(2000);
		commonUtils.click_CloseIcon_DownloadAvataar3DApp_popup();
	}
	...
	public void Verify_Upload_And_Submit_InTexturing_Test() throws InterruptedException {
		...
		try {
			...
			System.out.println("didn't click on successDialog - texturing artist upload stage");
		}
		Thread.sleep(2500);
		commonUtils.click_CloseIcon_DownloadAvataar3DApp_popup();
	}
	...
	public void Verify_Autoprocessing_Texturing_Test() throws InterruptedException {
		...
		for (int i=1; i<22; i++) {
			...
			try {
				commonUtils.click_productnameIfClickable();
				System.out.println("successfully completed autoprocessing after texturing");
				break;
			} catch (Exception e) {
				System.out.println("not clicked "+i+" time");
			}
	...
	public void Verify_TexturingQC_Accept_Test () throws InterruptedException {
		...
		try {
			...
			System.out.println("didn't click on successDialog - text artist qc feedback accept stage");
		}
		Thread.sleep(2500);
		commonUtils.click_CloseIcon_DownloadAvataar3DApp_popup();
	}
